...
float angle_x = 0.0f; // Ángulo de rotación
float angle_z = 0.0f; // Ángulo de rotación
...
void display()
{
    ...
    glRotatef(angle_x, 1.0f, 0.0f, 0.0f); // Rotar alrededor del eje x
    glRotatef(angle_z, 0.0f, 0.0f, 1.0f); // Rotar alrededor del eje z
    drawCube();
    glPopMatrix();
