...
void display()
{
    ...
    glPushMatrix();
    glRotatef(angle_1_cube1, 0.0f, 1.0f, 0.0f); // Rotación del padre
    drawCube();
    glPushMatrix();
    glTranslatef(1.5f, 0.0f, 0.0f);             // Distancia al hijo
    glRotatef(angle_1_cube2, 0.0f, 1.0f, 0.0f); // Rotación propia del hijo
