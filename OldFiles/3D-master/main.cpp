...
void display() {
    ...
    glTexCoord2f(8.0f, 0.0f); glVertex3f( 100.0f, -100.0f, 100.0f);
    glTexCoord2f(8.0f, 8.0f); glVertex3f( 100.0f, 100.0f, 100.0f);
    glTexCoord2f(0.0f, 8.0f); glVertex3f(-100.0f, 100.0f, 100.0f);*/
    glEnd();
